    ...
    <div className="border rounded-xl p-5 shadow-sm bg-white flex flex-col justify-between">
      ...
      <div className="mt-4 flex flex-col gap-2">
        ...
        <button
          ...
          className={`w-full bg-blue-600 hover:bg-blue-800 text-white py-2 rounded-lg transition ${
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`w-1/2 bg-yellow-500 hover:bg-yellow-600 text-white py-1 rounded transition ${
